...
# TODO for class
log_path="~/workspace/Information-retrival-hw4/train/log/train.log"
train_data_path="~/workspace/Information-retrival-hw4/data/data_train.json"
dev_data_path="~/workspace/Information-retrival-hw4/data/data_dev.json"
output_checkpoint_dir="~/workspace/Information-retrival-hw4/train/checkpoint"
model_file_path="~/workspace/Information-retrival-hw4/downloads/model/Lawformer_model"
